package com.ojs.question_repository.interceptors;

import com.tku.tku_oauth.oauth.model.TokenInfo;
import com.ojs.question_repository.utils.ApiUtil;
import com.ojs.question_repository.utils.MD5Util;
import com.ojs.question_repository.utils.NotRepeatSubmit;
...
public class TokenInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        request.setAttribute("user", tokenInfo.getUserInfo());//将token中的user信息放入request，提供给后续使用
